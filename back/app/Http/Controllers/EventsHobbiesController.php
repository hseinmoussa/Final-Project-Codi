...
use App\Http\Requests\Events_HobbiesRequest;


class EventsHobbiesController extends Controller
{
    protected $repository = null;

    public function __construct(Events_HobbiesInterface $repository)
    {
    ...
    public function index($rowNb)
    {
        ...
        $Events_Hobbies = $this->repository->index($rowNb);

        if ($Events_Hobbies) return Response::success($Events_Hobbies);
    ...
    public function freelancers($rowNb)
    {
        ...
        $Events_Hobbies = $this->repository->freelancers($rowNb);
    ...
    public function not_freelancers($rowNb)
    {
        ...
        $Events_Hobbies = $this->repository->not_freelancers($rowNb);
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(Events_HobbiesRequest $request)
    {
     ...
     *
     * @param  \App\Events_Hobbies $User_Hobby
     * @return \Illuminate\Http\Response
     */
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Events_HobbiesRequest $request, $id)
    {
